...
function Auth() {
  return (
    <div className="flex flex-col h-full justify-around">
      <div className="flex flex-col gap-2 text-center  items-center h-fit self-start ">
      ...
      <div className="align-">
        <form className="flex flex-col gap-4" action="GET">
          ...
          <div className="flex flex-col w-full text-center gap-4">
            ...
            <span className="text-base-content">criar uma nova conta</span>
          </div>
